...
import static name.lemerdy.sebastian.icloud.client.Assertions.assertThat;

public class ReminderResourceTest {
    @Test
    public void one_reminder_not_stopped() {
        ReminderResource reminderResource = new ReminderResource(new Reminders(new Reminder("1A6CE4B1-98ED-459F-ABA3-3301B43D9EC1", ZonedDateTime.of(2014, 5, 19, 9, 30, 0, 0, ZoneId.of("UTC")), null, "Lampes de chevet")));

        Set<ReminderResourceResult> reminderResourceResults = reminderResource.computeGraph();
    ...
    public void one_reminder_stopped() {
        ReminderResource reminderResource = new ReminderResource(new Reminders(new Reminder("1A6CE4B1-98ED-459F-ABA3-3301B43D9EC1", ZonedDateTime.of(2014, 5, 19, 9, 30, 0, 0, ZoneId.of("UTC")), ZonedDateTime.of(2014, 5, 21, 9, 30, 0, 0, ZoneId.of("UTC")), "Lampes de chevet")));
    ...
    public void should_create_computed_graph_with_two_reminders() {
        ReminderResource reminderResource = new ReminderResource(new Reminders(
